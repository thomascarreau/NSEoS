...
set xtics ("n_t" 0, "P_t" 1, "n_{sat}" 2, "{/Symbol l}_{sat}" 3, "K_{sat}" 4, "Q_{sat}" 5, "Z_{sat}" 6,"J_{sym}" 7, "L_{sym}" 8, "K_{sym}" 9, "Q_{sym}" 10, "Z_{sym}" 11, "{/Symbol k}_{sat}" 12, "{/Symbol k}_{sym}" 13, "b" 14)
set ytics ("n_t" 0, "P_t" 1, "n_{sat}" 2, "{/Symbol l}_{sat}" 3, "K_{sat}" 4, "Q_{sat}" 5, "Z_{sat}" 6,"J_{sym}" 7, "L_{sym}" 8, "K_{sym}" 9, "Q_{sym}" 10, "Z_{sym}" 11, "{/Symbol k}_{sat}" 12, "{/Symbol k}_{sym}" 13, "b" 14)
