        ...
        if (tqtt_ld.nt > 0.01) {
          ...
          if (mmax < 1.97) {
            ...
            fprintf(posterior_par,
                ...
                satdata.rhosat0, satdata.lasat0, satdata.ksat0, qsat_ld,
            ...
            fprintf(posterior_spar, "%g %g %g %g %g %g %g %g %g %g\n",
                ...
                sparams_ld.beta, sparams_hd.beta, sparams_ld.chi2,
                sparams_hd.chi2);
            fprintf(posterior_obs, "%g %g %g %g %g %g %g %g %g %g %g\n", mmax,
                tovs14.rhoc, tovs14.pc, tovs14.r, tqtt_ld.nt, tqtt_ld.pt,
                tovs14.rcore, tovs14.mcore, tovs14.i_over_mr2,
